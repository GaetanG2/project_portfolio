...
```bash
pnpm create astro@latest -- --template GaetanG2/project_portfolio
```
...
Based on [**Bartosz Jarocki - Print-friendly, minimalist CV page**](https://github.com/BartoszJarocki/cv) and [**Miguel Ángel Durán - minimalist-portfolio-json**](https://github.com/midudev/minimalist-portfolio-json) and [**Smilesharks - minimalist-portfolio-json**](https://github.com/Smilesharks/dev-portfolio/tree/main)